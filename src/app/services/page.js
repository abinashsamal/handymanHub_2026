...
export const metadata = {
  ...
  openGraph: {
    title: "Handyman Services in London, ON",
    description: "Handyman services in London: plumbing, electrical, carpentry, painting, furniture assembly, and more. Transparent pricing, free quotes.",
...
const ServiceCard = ({ icon, title, description, services, href }) => {
  const cardContent = (
    <>
      <div className="flex items-center mb-4">
        ...
        {href && (
          <svg className="w-5 h-5 text-[#e53935] ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const className = "bg-white rounded-lg shadow-lg p-8 block h-full hover:shadow-xl transition-shadow";
  if (href) {
    return (
